...
<div class="panel panel-primary">
    <div class="panel-heading">
         <h3 class="panel-title">
                            คุณอยู่ที่ >> บันทึกข้อมูลทะเบียน >> รายงานการเบิกวัสดุแยกตามผู้เบิก</h3>
        <!--<span class="pull-right clickable panel-collapsed" id="clickable"><i class="glyphicon glyphicon-plus"></i></span>-->
    </div>
</div>
<div style = "margin-left:10px;margin-right:10px;">	    

				<form class="navbar-form navbar-left" role="search" action = "index.php/report/person_withdrawal/search_person" method = "post">
				<h2><b>รายงานการเบิกวัสดุแยกตามผู้เบิก</b></h2>
				<div class="form-group">
					<h4><b>ผู้เบิกวัสดุทั้งหมด</b></h4>
		        </div>
		        <div class="form-group">
		           <select class="form-control" style = "width : 300px!important" name = "type_id" id = "type_id">
		           	    <option value = "0">เลือกผู้เบิกที่ต้องการ</option>
		           	  <?php foreach($person_mtr as $row){?>
                ...
                <a href = "index.php/report/person_withdrawal" class="btn btn-warning" >ค้นหาทั้งหมด</a>
...
<table class="table  table-bordered" id="dataTables-example">
  ...
  <center><a class = "btn btn-primary btn-lg" id = "report_pdf1" href = "index.php/report/report_button_print/mtr_person_withdrawal/<?php if($type_id != ""){ echo $type_id;}else{echo '0';} ?>" target = "_blank">ส่งออก PDF</a>&nbsp;<!--<a class = "btn btn-primary btn-lg" id = "report_pdf1" href = "index.php/report/report_button_print/report_main1_2" target = "_blank">ปริ้นรายงาน</a>--></center>
