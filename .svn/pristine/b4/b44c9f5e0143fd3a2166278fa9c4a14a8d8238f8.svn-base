                             ...
                             <div class="panel panel-primary">
                               <div class="panel-heading">
                                    <h3 class="panel-title">
                                       คุณอยู่ที่ >> บันทึกข้อมูลทะเบียน >> มูลค่าทรัพย์สินสุทธิที่ต่ำกว่า 5000</h3>
                                    <span class="pull-right clickable"><i class="glyphicon glyphicon-minus"></i></span>
                                </div>
                                <div class = "report_style">
                                    <h3><b>มูลค่าทรัพย์สินสุทธิที่ต่ำกว่า 5000</b></h3><br/>
                                <table class="table  table-bordered " id="sub1">
                                 ...
                                 <center><a class = "btn btn-primary btn-lg" id = "report_pdf3" href = "index.php/report/report_button_print/report_less50001_1" target = "_blank">ส่งออก PDF</a>&nbsp;<!--<a class = "btn btn-primary btn-lg" id = "report_pdf1" href = "index.php/report/report_button_print/report_less50001_2" target = "_blank">ปริ้นรายงาน</a>--></center>
                             </div>
                            </div>
