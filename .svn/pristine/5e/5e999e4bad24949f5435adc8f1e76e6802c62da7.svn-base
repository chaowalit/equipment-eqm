                            ...
                            <div class="panel panel-primary">
                               <div class="panel-heading">
                                    <h3 class="panel-title">
                                       คุณอยู่ที่ >> บันทึกข้อมูลทะเบียน >> รายงานทะเบียนการแจ้งซ่อม</h3>
                                    <span class="pull-right clickable"><i class="glyphicon glyphicon-minus"></i></span>
                                </div>
                                <div class = "report_style">
                                    <h3><b>รายงานทะเบียนการแจ้งซ่อม</b></h3><br/>
                                <table class="table  table-bordered " id="sub1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr  style="cursor:pointer" id = "<?php echo $row['eqm_id'];?>">
                                            ...
                                            <td class  =  "testButton" id = "<?php echo $row['eqm_id'];?>"><?php if($row['cost_total'] < 5000){echo "-";}else{echo $row['depreciation'];}?></td>
                                            <!-- 
                                            <td class  =  "testButton">
                                ...
                                <center><a class = "btn btn-primary btn-lg" id = "report_pdf4" href = "index.php/report/report_button_print/report_repaire1_1" target = "_blank">ส่งออก PDF</a>&nbsp;<!--<a class = "btn btn-primary btn-lg" id = "report_pdf4" href = "index.php/report/report_button_print/report_repaire1_2" target = "_blank">ปริ้นรายงาน</a>--></center>
                             </div>
                            </div>
                                ...
                                $(document).ready(function() {
                                  ...
                                  <script>
                                        $(document).ready(function(){
                                            ...
                                            var menu = [{
                                            name: 'รายงานทะเบียนการแจ้งซ่อม',
                                            img: 'icon/report.png',
                                            title: 'รายงานทะเบียนการแจ้งซ่อม',
                                            fun: function () {
                                               var id = $("#hideo").val();
